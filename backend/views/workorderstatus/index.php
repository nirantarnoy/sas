...
/* @var $searchModel backend\models\WorkorderstatusSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'สถานะใบแจ้งซ่อม';
...
<div class="workorderstatus-index">
    ...
    <div class="row">
        ...
        <div class="col-lg-2" style="text-align: right">
            <form id="form-perpage" class="form-inline" action="<?= Url::to(['workorderstatus/index'], true) ?>"
                  method="post">
