...
$my_workorder = \common\models\ViewEmpWorkAssign::find()->select(['workorder_id','workorder_status'])->where(['workorder_created_by' => \Yii::$app->user->id])->groupBy(['workorder_id'])->all();
